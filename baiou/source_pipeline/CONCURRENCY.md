...
```powershell
python -m baiou.source_pipeline.run_case_plan `
  --plan baiou/source_pipeline/case_plan_template.csv `
...
```text
outputs/baiou/source/case_runs/{case_id}/group/
```
...
```text
baiou/config/source_pipeline/run_options.yaml
```
