...
from baiou.source_pipeline.config_loader import BATCHES_ROOT, CASE_RUNS_ROOT, PREPARED_ROOT
...
def collect(batch_id: str, case_ids: list[str], defer_failed_groups_gt: int, overwrite: bool = False) -> Path:
    ...
    write_json(batch_dir / "handoff.json", {
        ...
        "pipeline": "baiou.source_pipeline",
        "batch_id": batch_id,
        "main_entry": "batch_chat_turns.json",
        "cases_dir": "cases",
        "next_pipeline": "baiou.case_pipeline",
        "notes": "Case pipeline should read this bundle root, not a copied standalone JSON file.",
    })
