                    ...
                    rows.append(
                        {
                            ...
                            "question_cn": "这句话/区域说话人或文字不确定。请看 context_before/context_after 和 source_image 定位；如果是表情包，直接选“男生表情包/女生表情包”；如果 current_text 为空，通常是空白气泡/头像/误识别，可选“跳过”；如果确实有文字，请在 corrected_text 写正确文字。",
                            "your_choice": "",
                            "corrected_speaker": "",
                            "corrected_text": "",
                            "notes": "",
                    ...
                    rows.append(
                        {
                            ...
                            "block_extracted_text": str(block.get("extracted_text", "")),
                            "model_reason": str(turn.get("reason", "")),
                            "question_cn": f"模型标为旁白，但不像讲解/复盘文本，疑似错标（建议改为：{speaker_label(suggested)}）。如果这是表情包，请直接选“男生表情包/女生表情包”。请根据上下文确认。",
                            "your_choice": "",
                            "corrected_speaker": "",
                            "corrected_text": "",
                            "notes": "",
                ...
                rows.append(
                    {
                        ...
                        "block_extracted_text": "",
                        "model_reason": "",
                        "question_cn": "这张图片被模型安全策略拦截，没有生成话轮。请打开 source_image 人工转写；一行可写多句，建议格式：男生：... / 女生：... / 旁白：...",
                        "your_choice": "",
                        "corrected_speaker": "",
                        "corrected_text": "",
...
def write_xlsx(path: Path, rows: list[dict[str, Any]]) -> None:
    ...
    guide.append(["字段", "说明"])
    guide_rows = [
        ("your_choice", "下拉选择处理方式。普通文字选“改为男生/女生/旁白/系统”；表情包选“男生表情包/女生表情包”；无法识别内容可选“跳过/无法判断”。"),
