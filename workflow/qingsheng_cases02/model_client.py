...
class ChatModelClient:
    ...
    def chat_json(self, system_prompt: str, user_prompt: str) -> dict[str, Any]:
        ...
        if not self.config.get("thinking"):
            payload["temperature"] = self.config.get("temperature", 0.0)
        ...
        except Exception as exc:  # noqa: BLE001 - batch should continue and report the failure.
...
def parsed_usage(parsed: dict[str, Any]) -> dict[str, Any]:
    return parsed.get("usage", {}) if isinstance(parsed.get("usage", {}), dict) else {}
