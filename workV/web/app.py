...
from workflow.common.io import PROJECT_ROOT, load_data, read_json, write_json
from workV.runtime.reply_engine import run_reply

CONFIG_ROOT = PROJECT_ROOT / "workV" / "config"
DEFAULT_CONFIG = {
...
def load_web_config(path: str | Path | None = None) -> dict[str, Any]:
    ...
    config_path = resolve_path(path or os.environ.get("WORKV_WEB_CONFIG", CONFIG_ROOT / "web.json"))
