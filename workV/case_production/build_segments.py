        ...
        rows.append(
            {
                ...
                "当前状态": f"quality_status={segment.get('quality_status', 'draft')}；need_human_review={segment.get('need_human_review', False)}",
                "人工结论": "",
                "人工修正": "",
                "备注": "",
            }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build workV segments_v01 from source_to_chat_turns01 batch output.")
